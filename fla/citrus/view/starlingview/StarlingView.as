package citrus.view.starlingview {
	...
	public class StarlingView extends ACitrusView {
		...
		override protected function createArt(citrusObject:Object):Object {
			...
			{
				(citrusObject as APhysicsObject).viewArt = art;
				if (viewObject.viewAutoSize == true)
				{
					art.content.width = viewObject.width;
					art.content.height = viewObject.height;
				}
				(citrusObject as APhysicsObject).onViewArt.dispatch();
			}
