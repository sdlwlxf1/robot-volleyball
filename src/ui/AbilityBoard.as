package ui 
{
	...
	public class AbilityBoard extends Sprite 
	{
		...
		private function onAddedToStage(e:Event):void 
		{
			...
			background = new Image(Assets.getTexture("selectBackground"));
			...
			background.x = _textField1.x - offsetX;
			background.y = _textField1.y - offsetY;
			
			background.height = this.height + offsetX * 2;
			background.width = this.width + offsetY * 2 + 8;
						
			addChildAt(background, 0);
			
			this.pivotX = background.x;
			this.pivotY = background.y;
