package ui.screen 
{
	 ...
	 * @author lixuefeng
	 */
	public class TrainSetKeyScreen extends TrainScreen 
	{
		...
		public function TrainSetKeyScreen() 
		{
			super();
		...
		{						
			...
			screenController.dispatchSignal(ScreenConst.TRAIN_SETKEY_SCREEN, ScreenConst.BACK_BUTTON_CLICK, this);
		}
		...
		{		
			...
			_ce.input.keyboard.addKeyAction("pause", Keyboard.Q);
