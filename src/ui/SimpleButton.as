...
package ui
{
    ...
    public class SimpleButton extends DisplayObjectContainer
    {
		...
		public var onOut:Signal;
		public var onEnded:Signal;
        ...
        public function SimpleButton(upState:Texture, text:String="", downState:Texture=null, overState:Texture=null)
        {
        ...
        private function onTouch(event:TouchEvent):void
        {
			...
			if(touch.phase == TouchPhase.HOVER && !mIsDown && !mIsOver)
			{
        ...
        public function set fontBold(value:Boolean):void
        {
		 ...
		 /** Indicates if the font should be bold. */
        public function get fontItalic():Boolean { return mTextField ? mTextField.italic : false; }
        public function set fontItalic(value:Boolean):void
        {
            createTextField();
            mTextField.italic = value;
        }
		
		 /** Indicates if the font should be bold. */
        public function get fontFilter():FragmentFilter { return mTextField ? mTextField.filter : null; }
        public function set fontFilter(value:FragmentFilter):void
        {
            createTextField();
            mTextField.filter = value;
        }
