package data 
{
	...
	public class UserData
	{
		...
		public var p1KeySet:Object = { "jumpKey":Keyboard.W, "leftKey":Keyboard.A, "rightKey":Keyboard.D, "downKey":Keyboard.S, "generalHitBallKey":Keyboard.J, "specialHitBallKey":Keyboard.K, "skill1Key":Keyboard.L };		
		
		public var p2KeySet:Object = { "jumpKey":Keyboard.UP, "leftKey":Keyboard.LEFT, "rightKey":Keyboard.RIGHT, "downKey":Keyboard.S, "generalHitBallKey":Keyboard.N, "specialHitBallKey":Keyboard.M, "skill1Key":Keyboard.COMMA };		
		
		public var p1KeyReset:Object = { "jumpKey":Keyboard.W, "leftKey":Keyboard.A, "rightKey":Keyboard.D, "downKey":Keyboard.S, "generalHitBallKey":Keyboard.J, "specialHitBallKey":Keyboard.K, "skill1Key":Keyboard.L  };		
		
		public var p2KeyReset:Object = { "jumpKey":Keyboard.UP, "leftKey":Keyboard.LEFT, "rightKey":Keyboard.RIGHT, "downKey":Keyboard.S, "generalHitBallKey":Keyboard.N, "specialHitBallKey":Keyboard.M, "skill1Key":Keyboard.COMMA  };
		
		public var firstOpenMatch:Boolean = false;
		
		
		private var _abilityObject:Object = { jump:2, move:2, quick:2, power:2 };
		
		private var _unLockArmsObject:Array = [0];
		private var _ownArmsObject:Array = [0];	
		private var _equipedArm:int = 0;		
		
		private var _unLockShoulderMotorsObject:Array = [0];
		private var _ownShoulderMotorsObject:Array = [0];
		private var _equipedShoulderMotor:int = 0;
		
		private var _unLockWaistMotorsObject:Array = [0];
