package gameObjects 
{
	...
	public class Wall extends StaticObject 
	{
		...
		override protected function defineFixture():void
		{
			...
			_fixtureDef.filter.categoryBits = PhysicsCollisionCategories.Get("Wall");
		...
		/*override protected function beginContactHanlder(selfBody:b2Body, contactedBody:b2Body):void 
		{
			...
			{
				contactedBody.GetLinearVelocity().x *= -1.1;
		...
		override public function handleBeginContact(contact:b2Contact):void 
		{
			...
			var collider:IBox2DPhysicsObject = Box2DUtils.CollisionGetOther(this, contact);
			if (collider.body.GetUserData().name == "ball")
			{
				collider.body.GetLinearVelocity().x *= -1;
				getStateByName("touchBall").phase = Process.BEGIN;
			}
		}
