package gameObjects
{
	...
	public class PhysicsObject extends Box2DPhysicsObject
	{
		...
		private var _actionsVector:Vector.<Action>;
		...
		override protected function createBody():void 
		{
			...
			//_body.m_customTimeStep = new b2TimeStep();
			/*_body.m_customTimeStep.dt = _box2D.timeStep * _ce.timeScale;
			_body.m_customTimeStep.positionIterations = _box2D.positionIterations;
			_body.m_customTimeStep.velocityIterations = _box2D.velocityIterations;*/
			//_body.m_customTimeStepDtScale = 0.1;
			
		}
		
		public function setTimeScale(timeScale:Number = 1):void
		{
			_body.m_customTimeStep.dt *= timeScale;
		}
