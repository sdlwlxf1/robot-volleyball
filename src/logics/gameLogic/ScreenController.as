package logics.gameLogic 
{
	...
	import ui.screen.CurtainScreen;
	import ui.screen.DeveloperScreen;
	...
	import ui.screen.SetKeyScreen;
	import ui.screen.ShopScreen;
	import ui.screen.SingleScreen;
				...
				case ScreenConst.MATCH_SCREEN:
					switch(signalID)
					{
						...
						case ScreenConst.SET_BUTTON_CLICK:
							...
							(_ce.state as StarlingState).stage.addChild(_setKeyScreen);
							break;
