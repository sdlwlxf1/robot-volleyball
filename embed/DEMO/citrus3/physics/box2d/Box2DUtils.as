package citrus.physics.box2d {
	...
	public class Box2DUtils
	{
		...
		static public function B2Vec2toAngle(vector:b2Vec2):Number {
			return Math.atan2(vector.y, vector.x);
		}
		
		static public function Verticalb2Vec2(vector:b2Vec2, a:Number = 1):b2Vec2 {
			return new b2Vec2(a, -vector.x / vector.y * a);
		}
	}
}