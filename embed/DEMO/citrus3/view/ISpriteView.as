package citrus.view
{
	...
	{	
		...
		/**
		 * code by lixuefeng 2013/2/25 if true: The size of the view according to the height and width attributes to be automatic adjustment.
		 */
		function get viewAutoSize():Boolean;
