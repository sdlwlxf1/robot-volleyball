package test2.factory
{
	...
	public class PlayerFactory extends Object
	{
		...
		public function createPlayer(playerData:PlayerData, factory:StarlingFactory):Player
		{
			...
			//初始化主角
			_player = new Player(_playerData.name, {x: _playerData.startX, y: _playerData.startY, width: 10, height: 10/*_viewSprite.height*/, offsetY: 0, view: _armature, registration: "topLeft", data: _playerData});
			...
			_arm1 = new Hand("forearm", {player: _player, invertedViewAndBody: _player.invertedViewAndBody, width: _arm1Display.width * _playerData.scale, height: _arm1Display.height * _playerData.scale, followView: _arm1Display /*, view:SpriteDebugArt*/});
			CitrusEngine.getInstance().state.add(_arm1);
			
			_arm2 = new Hand("forearm_R", {player: _player, invertedViewAndBody: _player.invertedViewAndBody, width: _arm2Display.width * _playerData.scale, height: _arm2Display.height * _playerData.scale, followView: _arm2Display /*, view:SpriteDebugArt*/});
