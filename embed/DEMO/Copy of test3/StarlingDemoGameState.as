package test2
{
	...
	public class StarlingDemoGameState extends StarlingState
	{
		...
		private function _textureCompleteHandler(e:flash.events.Event):void
		{
			...
			//初始化主角
			player1 = new Player("robot左", {x: 250, y: 480, width: (_armature.display as Sprite).width - 60, height: (_armature.display as Sprite).height, offsetY: -10, view: _armature, registration: "topLeft", invertedBody: false, control: "keyboard"});
			...
			player2 = new Player("robot右", {x: 750, y: 480, width: (_armature2.display as Sprite).width - 60, height: (_armature2.display as Sprite).height, offsetY: -10, view: _armature2, registration: "topLeft", invertedBody: true, control: "auto"});		
