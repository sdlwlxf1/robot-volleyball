package test2.data 
{
	...
	public class PlayerData extends Data 
	{
		...
		public var velocityVec:b2Vec2 = new b2Vec2(3.2, 0);
		private var _maxVelocity:Number = 6;
		private var _minVelocity:Number = 3.2;
				
		public var jumpHeight:Number = 11;
		private var _maxJumpHeight:Number = 18;
		private var _minJumpHeight:Number = 11;
		
		public var jumpAcceleration:Number = 0.3;
		
		public var serveBallVec:b2Vec2 = new b2Vec2(0, -13);
		
		public var powerMax:Number = 5;
		private var _maxPowerMax:Number = 20;
