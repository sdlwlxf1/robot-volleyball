package test2.ui.screen 
{
	...
	public class SingleScreen extends Screen 
	{
		...
		override protected function initScreens():void 
		{
			...
			armSelectBoard.y = stage.stageHeight / 2 - armSelectBoard.height / 2 - 150;
			...
			waistMotorSelectBoard.y = stage.stageHeight / 2 - waistMotorSelectBoard.height / 2 + 150;
			...
			_playerData1.inputName = { "down":"p1down", "right":"p1right", "left":"p1left", "jump":"p1jump", "hitLeft":"p1hitLeft", "hitRight":"p1hitRight"};
			...
			_levelText.x = stage.stageWidth - 250;
			_levelText.y = 200;
			addChild(_levelText);
