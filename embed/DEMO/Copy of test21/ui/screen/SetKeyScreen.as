package test2.ui.screen 
{
	...
	public class SetKeyScreen extends Screen 
	{
		...
		private function getResetKey(object:Object):Object
		{
			...
			object1["hitRightKey"] = object["hitRightKey"];
			object1["hitLeftKey"] = object["hitLeftKey"];
			return object1;
		}
		...
		{		
			...
			_ce.input.keyboard.addKeyAction("p1hitLeft", _keyValue["hitLeftKey"]);
			_ce.input.keyboard.addKeyAction("p1hitRight", _keyValue["hitRightKey"]);
			...
			_ce.input.keyboard.addKeyAction("p2hitLeft", _keyValue["hitLeftKey"]);
			_ce.input.keyboard.addKeyAction("p2hitRight", _keyValue["hitRightKey"]);
