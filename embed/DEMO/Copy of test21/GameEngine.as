package test2
{
	...
	{	
		...
		override protected function handleAddedToStage(e:Event):void 
		{
			...
			_input.keyboard.addKeyAction("p1hitLeft", UserData.getInstance().p1KeySet["hitLeftKey"]);
			_input.keyboard.addKeyAction("p1hitRight", UserData.getInstance().p1KeySet["hitRightKey"]);
			...
			_input.keyboard.addKeyAction("p2hitLeft", UserData.getInstance().p2KeySet["hitLeftKey"]);
			_input.keyboard.addKeyAction("p2hitRight", UserData.getInstance().p2KeySet["hitRightKey"]);
