package test2.state
{
	...
	public class MatchState extends StarlingState
	{
		...
		private var _overSky:CitrusSprite;
		...
		override public function initialize():void
		{
			...
			var overSkyImage:Image = new Image(Assets.getTexture("overSky"));
			overSkyImage.pivotX = overSkyImage.width >> 1;
			_overSky = new CitrusSprite("overSky", { view: overSkyImage} );
			add(_overSky);
			//_overSky.view.alpha = 0;
		...
		override public function update(timeDelta:Number):void
		{
			...
			if (ball.y < 0)
			{
				_overSky.y = 0;
				_overSky.x = ball.x;
				_overSky.view.alpha = 0.8;
			}
			else
			{			
				_overSky.y = -_overSky.height;
				_overSky.view.alpha = 0;
			}
