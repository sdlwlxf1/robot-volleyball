...
public class b2Island
{
	...
	public function Solve(timeStep:b2TimeStep, gravity:b2Vec2, allowSleep:Boolean) : void
	{
		var i:int;
		var j:int;
		var b:b2Body;
		...
		for (i = 0; i < m_bodyCount; ++i)
		{
			...
			//2013-7-14
			//added by lixuefeng
			if (b.m_customTimeStep != null) {
				b.m_customTimeStep.Set(step);
				b.m_customTimeStep.dt = b.m_customTimeStepDtScale;
				
				
				step = b.m_customTimeStep;
			}else {
				step = timeStep;
			}
			//------------------------------------
